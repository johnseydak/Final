...
<div class="allupcomingevents">
    ...
    <div class="upcomingevents2">
        <div class="dateblock2">
            <div class="date2">
                <div class="line3">30</div>
                <div class="line4">JUL</div>
            </div>
        </div>
        <div class="text2">
            <div class="blurb3"><p>Sed et persipiatis unde omnis iste natus</p></div>
            <div class="blurb4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid temporibus quos aspernatur</div>
        </div>
    </div>
    <div class="upcomingevents3">
        <div class="dateblock3">
            <div class="date3">
                <div class="line5">30</div>
                <div class="line6">AUG</div>
            </div>
        </div>
        <div class="text3">
            <div class="blurb5"><p>Sed et persipiatis unde omnis iste natus</p></div>
            <div class="blurb6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid temporibus quos aspernatur</div>
        </div>
    </div>
    <div class="upcomingevents4">
        <div class="dateblock4">
            <div class="date4">
                <div class="line7">23</div>
                <div class="line8">NOV</div>
            </div>
        </div>    
        <div class="text4">
            <div class="blurb7"><p>Sed et persipiatis unde omnis iste natus</p></div>
            <div class="blurb8">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid temporibus quos aspernatur</div>
        </div>
    </div>
    <div class="upcomingevents5">
        <div class="dateblock5">
            <div class="date5">
                <div class="line9">23</div>
                <div class="line10">DEC</div>
            </div>
        </div>
        <div class="text5">
            <div class="blurb9"><p>Sed et persipiatis unde omnis iste natus</p></div>
            <div class="blurb10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid temporibus quos aspernatur</div>
        </div>
    </div>
</div>`
...
<div class="galleryheadline">GALLERY:</div>
<div class="galleryborder"></div>
<div class="gallerysection">
    <div class="row1">
        <div class="image1" a id="gallery1" href="#"></div>
        <div class="image2" a id="gallery2" href="#"></div>
        <div class="image3" a id="gallery3" href="#"></div> 
    </div>
    <div class="row2">
        <div class="image4" a id="gallery4" href="#"></div>
        <div class="image5" a id="gallery5" href="#"></div>
    </div>
</div>
</div>`
